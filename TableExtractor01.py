...
class TableExtractor:
    ...
    def find_contours(self):
        ...
        self.image_with_all_contours = self.cut_table_image.copy()
    ...
    def filter_contours_and_leave_only_rectangles(self):
        ...
        self.image_with_only_rectangular_contours = self.cut_table_image.copy()
    ...
    def find_largest_contour_by_area(self):
        ...
        self.image_with_contour_with_max_area = self.cut_table_image.copy()
    ...
    def apply_perspective_transform(self):
        if self.contour_with_max_area_ordered is not None:
            ...
            self.perspective_corrected_image = cv2.warpPerspective(self.thresholded_image, matrix, 
